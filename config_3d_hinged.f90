...
IMPLICIT NONE
    ...
    !------------------------------------------------------------------------
    INTEGER                          :: nbody
    REAL                             :: height,ang,rhob
    REAL                             :: stiff,damp,joint1_angle,init_angle
    REAL,DIMENSION(3)                :: gravity,joint1_orient
    ...
    joint1_dof(1)%stiff = 0.0
    ALLOCATE(joint1_dof(1)%damp(1))
    joint1_dof(1)%damp = 0.001;
    ...
    joint1_dof(2)%motion_params = (/ 0.05, 1.0, 0.0 /)
