...
SUBROUTINE embed_system_init(init_time)
...
IMPLICIT NONE
    ...
    CALL jcalc(joint_system(1)%joint_id, 0.0_dp)
    ...
    DO i = 1, system%njoint
        ...
        DO j = 1,body_system(i)%nchild
            ...
            CALL jcalc(joint_system(child_id)%joint_id, 0.0_dp)
...
END SUBROUTINE embed_system_init